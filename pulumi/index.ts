...
// Bucket versioning
const dataLakeBucketVersioning = new aws.s3.BucketVersioning("data_lake_bucket_versioning", {
    bucket: dataLakeBucket.id,
...
const dataLakeBucketEncryption = new aws.s3.BucketServerSideEncryptionConfiguration("data_lake_bucket_encryption", {
    bucket: dataLakeBucket.id,
    rules: [{
...
const dataLakeBucketLifecycle = new aws.s3.BucketLifecycleConfiguration("data_lake_bucket_lifecycle", {
    bucket: dataLakeBucket.id,
    rules: [{
        id: "transition-to-ia",
        status: "Enabled",
...
const lambdaArtifactsBucketVersioning = new aws.s3.BucketVersioning("lambda_artifacts_versioning", {
...
const lambdaArtifactsBucketEncryption = new aws.s3.BucketServerSideEncryptionConfiguration("lambda_artifacts_encryption", {
    bucket: lambdaArtifactsBucket.id,
    rules: [{
        applyServerSideEncryptionByDefault: {
            sseAlgorithm: "AES256",
