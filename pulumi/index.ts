        ...
        Statement: [
            {
                ...
                Resource: [
                    "arn:aws:s3:::data-pipeline-test-data-lake-894850187425",
                    "arn:aws:s3:::data-pipeline-test-data-lake-894850187425/*",
                ],
            },
            {
                ...
                Resource: "arn:aws:sqs:us-east-1:894850187425:data-pipeline-test-data-processing",
            },
            {
                Effect: "Allow",
                Action: [
                ...
                Resource: "arn:aws:logs:us-east-1:894850187425:*",
            },
        ],
    }),
}, { provider: awsProvider });
