...
// Default tags (Project, Environment, ManagedBy) are configured via the AWS
// provider's defaultTags in Pulumi.dev.yaml, mirroring Terraform's
// provider "aws" { default_tags { ... } } block.
