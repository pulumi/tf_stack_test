...
const dataLakeBucketVersioning = new aws.s3.BucketVersioning("data_lake_bucket", {
    bucket: dataLakeBucket.id,
    versioningConfiguration: {
        status: "Enabled",
    },
...
const dataLakeBucketLifecycle = new aws.s3.BucketLifecycleConfiguration("data_lake_bucket", {
    bucket: dataLakeBucket.id,
    rules: [{
        id: "transition-to-ia",
        status: "Enabled",
